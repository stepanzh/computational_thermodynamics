...
где
- `ГОД >= 2023` это год **преподавания**, к которому относится изменение.
   Т.е. если какой-то материал читался в 2022 году, но был оцифрован и попал в книгу в 2023 (например, в январе), то `ГОД` считается 2022-ым.
- `MAJOR >= 0` касается крупных изменений.
   Например,
...
- `MINOR >= 0` касается мелких изменений.
