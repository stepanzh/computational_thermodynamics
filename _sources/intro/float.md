...
Множество действительных чисел $\real$ неограничено и непрерывно. Однако, в вычислительной практике используется множество *чисел с плавающей точкой* $\floatset\subset\real$, которое ограничено и дискретно. Это порождает особенности арифметики.
...
```{proof:observation}
Сложение в числах с плавающей точкой  *неассоциативно*.
```
