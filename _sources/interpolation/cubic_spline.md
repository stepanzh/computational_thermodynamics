...
Таким образом, для построения сплайна необходимо знать $4n$ коэффициентов $a_k$, $b_k$, $c_k$ и $d_k$. Из определения сплайна можно составить систему уравнений на непрерывность сплайна, а именно на
