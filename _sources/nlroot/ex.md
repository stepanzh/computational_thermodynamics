...
$$
F(G) = \sum_{i} \frac{z_i (K_i - 1)}{G (K_i - 1) - 1} = 0,
$$
...
Напишите функцию `rachford_rice_solve(z, K) -> G`, решающую уравнение фазовых концентраций. Постройте графики функции $F(G)$ с нанесённым корнем $F(G) = 0$ для случаев
