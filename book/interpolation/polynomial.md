...
Задача **полиномиальной интерполяции** по точкам $(t_n, y_1), (t_2,ny_2), ..., (t_n, y_n)$, где все $t_i$ различны, заключается в построении полинома степени не выше $n$, проходящего через все данные точки, т.е.
