...
Чтобы решать такие задачи, применяются методы регуляризации, с некоторыми из них вы можете ознакомится по [работам Андрея Николаевича Тихонова](https://www.mathnet.ru/php/person.phtml?option_lang=rus&personid=20380) (1906-1993).
Методы регуляризации, как правило, подменяют исходную задачу очень похожей, но с допустимой ошибкой решения и с такой чувствительностью к входным данным, что решение задачи можно использовать на практике.
