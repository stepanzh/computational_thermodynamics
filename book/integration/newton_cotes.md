...
Ниже приведены некоторые составные квадратурные формулы Ньютона-Котеса.
...
Просуммировав {eq}`quadrature_composite`, получим составную квадратурную формулу для отрезка $[a, b]$:
...
1. Ниже приведена заготовка функции, находящей узлы и коэффициенты формулы Ньютона-Котеса, точной для многочлена степени $p$.
    Заполните пропуски `⟨...⟩`
